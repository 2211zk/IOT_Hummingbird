...
<template>
  ...
  <el-input v-model="searchInfo.prName" placeholder="搜索条件" />
</el-form-item>
    ...
    <div class="gva-table-box">
        <div class="gva-btn-list">
            ...
            <ExportTemplate v-auth="btnAuth.exportTemplate" template-id="wl_playform_WlProducts" />
            <ExportExcel v-auth="btnAuth.exportExcel" template-id="wl_playform_WlProducts" filterDeleted/>
            <ImportExcel v-auth="btnAuth.importExcel" template-id="wl_playform_WlProducts" @on-success="getTableData" />
        </div>
        <el-table
        ref="multipleTable"
        style="width: 100%"
        ...
        <el-table-column sortable align="left" label="日期" prop="CreatedAt"width="180">
            ...
            <el-table-column align="left" label="产品名称" prop="prName" width="120" />

            <el-table-column align="left" label="所属品类" prop="prCategory" width="120">
    <template #default="scope">
    {{ filterDict(scope.row.prCategory,CategoryOptions) }}
    </template>
</el-table-column>
            <el-table-column align="left" label="标准品类" prop="standardQuality" width="120" />

            <el-table-column align="left" label="节点类型" prop="nodeType" width="120">
    <template #default="scope">
    {{ filterDict(scope.row.nodeType,Node_typeOptions) }}
    </template>
</el-table-column>
            <el-table-column align="left" label="接入协议" prop="accessProtocol" width="120">
    <template #default="scope">
    {{ filterDict(scope.row.accessProtocol,access_protocolOptions) }}
    </template>
</el-table-column>
            <el-table-column align="left" label="数据格式" prop="dataFormat" width="120">
    <template #default="scope">
    {{ filterDict(scope.row.dataFormat,data_formatOptions) }}
    </template>
</el-table-column>
            <el-table-column align="left" label="网络类型" prop="networkType" width="120">
    <template #default="scope">
    {{ filterDict(scope.row.networkType,Network_typeOptions) }}
    </template>
</el-table-column>
            <el-table-column align="left" label="工厂" prop="factory" width="120" />

            <el-table-column align="left" label="产品描述" prop="prInfo" width="120" />
        ...
        <el-table-column align="left" label="操作" fixed="right" :min-width="appStore.operateMinWith">
            ...
            <el-button v-auth="btnAuth.edit" type="primary" link icon="edit" class="table-button" @click="updateWlProductsFunc(scope.row)">编辑</el-button>
    ...
    {{ detailFrom.prCategory }}
</el-descriptions-item>
                    <el-descriptions-item label="标准品类">
    {{ detailFrom.standardQuality }}
</el-descriptions-item>
                    <el-descriptions-item label="节点类型">
    {{ detailFrom.nodeType }}
</el-descriptions-item>
                    <el-descriptions-item label="接入协议">
    {{ detailFrom.accessProtocol }}
</el-descriptions-item>
...
const getTableData = async() => {
  const table = await getWlProductsList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
