...
func (i *initMenu) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	childMenus := []SysBaseMenu{
		...
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["systemTools"], Path: "sysSet", Name: "sysSet", Component: "view/system/sysSet.vue", Sort: 8, Meta: Meta{Title: "系统设置", Icon: "el-icon-setting"}},
