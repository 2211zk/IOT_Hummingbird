...
const (
	...
	UserService_RegisterCompensate_FullMethodName = "/user.v1.UserService/RegisterCompensate"
...
type UserServiceClient interface {
	...
	RegisterCompensate(ctx context.Context, in *RegisterCompensateRequest, opts ...grpc.CallOption) (*RegisterCompensateReply, error)
...
func (c *userServiceClient) RegisterCompensate(ctx context.Context, in *RegisterCompensateRequest, opts ...grpc.CallOption) (*RegisterCompensateReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RegisterCompensateReply)
	err := c.cc.Invoke(ctx, UserService_RegisterCompensate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	RegisterCompensate(context.Context, *RegisterCompensateRequest) (*RegisterCompensateReply, error)
...
func (UnimplementedUserServiceServer) RegisterCompensate(context.Context, *RegisterCompensateRequest) (*RegisterCompensateReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterCompensate not implemented")
}
...
func _UserService_RegisterCompensate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegisterCompensateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).RegisterCompensate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_RegisterCompensate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).RegisterCompensate(ctx, req.(*RegisterCompensateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RegisterCompensate",
			Handler:    _UserService_RegisterCompensate_Handler,
		},
		{
			MethodName: "Login",
